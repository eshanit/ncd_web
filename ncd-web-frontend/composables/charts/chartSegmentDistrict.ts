...
const chartSegmentDistrict = async (data: any) => {
  return data.then((response: any) => {
    ...
    test:mean(iieknowledgeArr),
      ...
      lineColumn: {
              ...
              annotations: {
                xaxis: [{
                    ...
                    label: {
                      ...
                      text: 'Mean Score'+`(${mean(iieAcquiredSkillArr).toFixed(2)})`,
                    }
                  },
                  {
        ...
        optionsmngtAcquiredSkill:{chart: {
            height: 350,
            type: "line",
            stacked: false,
          },
          annotations: {
            xaxis: [{
                ...
                label: {
                  ...
                  text: 'Mean Score'+`(${mean(mngtAcquiredSkillArr).toFixed(2)})`,
                }
              },
              {
...
export default chartSegmentDistrict;
