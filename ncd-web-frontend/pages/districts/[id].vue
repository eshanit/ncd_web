        ...
        <UContainer>
                ...
                <template #header>
                    <div class="flex my-2">
                        <div class="text-orange-500 pr-1 text-sm"><strong>DM Segment Analysis</strong></div>|<div
                            class="text-green-500 pl-1 text-sm">{{ districtId }}</div>
                    </div>
                    <div class="text-sm">
            ...
            <UCard>
                <template #header>
                    ...
                    <div class="text-sm">The overview radar charts gives insight at a top-level on perfomance of <span class="text-green-500 italic">{{ districtId }}</span> mentees. With this analysis one can
