...
<template>
     <header class="bg-white fixed top-0 w-full shadow-md">
        <nav class="container mx-auto px-6 py-3">
            <div class="flex  items-center" v-if="mentee">
                ...
                <NuxtLink :to="{
                    ...
                    <p class="p-1 hover:text-green-500">Mentees Analysis</p>
                </NuxtLink>
                <p>|</p>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q1
                            ...
                            <span v-if="mentee.scores[0].dmQ1 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ1
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q8
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ8 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ8
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 "> Q11
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ11 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ11
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q2
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ2 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ2
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q9
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ9 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ9
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q3
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ3 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ3
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q10
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ10 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ10
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 "> Q13
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ13 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ13
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q4
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ4 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ4
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q5
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ5 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ5
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q6
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ6 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ6
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center border-b border-gray-500">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q7
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ7 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ7
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q14
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ14 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ14
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q23
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ23 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ23
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 "> Q29
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ29 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ29
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q15
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ15 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ15
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q24
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ24 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ24
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q16
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ16 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ16
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q25
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ25 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ25
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q17
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ17 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ17
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q26
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ26 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ26
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q18
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ18 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ18
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q27
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ25 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ27
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q19
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ19 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ19
                            }}</strong></span>
                    ...
                    <div class=" border-t border-gray-500  text-center X">
                        <div class="text-gray-500 p-5 border-l border-r  border-green-500"> Q28
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ28 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ28
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q20
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ20 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ20
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q21
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ21 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ21
                            }}</strong></span>
                ...
                <div class="grid grid-cols-3 items-center ">
                    <div class=" border-t border-gray-500  text-center ">
                        <div class="text-gray-500 p-5"> Q22
                            <UIcon name="i-heroicons-arrow-long-right" />
                            <span v-if="mentee.scores[0].dmQ22 == 0" class="text-gray-500"><strong>{{ mentee.scores[0].dmQ22
                            }}</strong></span>
